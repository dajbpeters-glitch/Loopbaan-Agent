...
st.set_page_config(page_title='Loopbaan-Agent 3.0.2',page_icon='🧭',layout='wide')
...
st.title('🧭 Loopbaan-Agent 3.0.2');st.caption('Multi-source zoeken vanuit Loopbaan-DNA, maatschappelijke opgaven en roltypen — met Adzuna, Jooble en je eigen bibliotheek.')
